...
@section('body')
<form action="/security-flow/step-1/create/highlights" method="post">
@csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12">
                                    <div class="content-form">
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-3">
                                                <p>Funds Due</p><input placeholder="30/06/2019" type="text" name="funds-due" value="{{ isset($data['funds-due']) ? $data['funds-due'] : '' }}">
                                            </div>
                                            <div class="col-xs-12 col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="content-footer">
                                <a href="/security-flow/step-1/details" class="footer-button-back">
...
<script>
    $(document).ready(function() {
        $('input[name="funds-due"]').datepicker();
        $('input[name="offers-due"]').datepicker();
        $('input[name="distribution-commencement"]').datepicker();
    });
</script>
@endsection
