...
<div class="card margin-top-m">
                    ...
                    <div class="row margin-bottom-s">
                        <div class="col-xs-12 col-md-8">
                            <p>Pre-Tax Returns calculated using the highest Federal Marginal tax rate of
                                37% plus an 8% allowance for state and local taxes.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row reverse">
        <div class="col-xs-12 col-md-6 margin-bottom-m margin-right-m">
            <div class="row">
                ...
                <a href="{{'/investor-servicing/tax-document/'. $type. '/'.strtolower(str_random(30)). '/' .$id }}" class="col-xs-12 col-sm-4">
                    <div class="btn full-width margin-bottom-m-sm">Next</div>
                </a>
            </div>
        </div>
    </div>
