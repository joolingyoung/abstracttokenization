...
<div class="col-md-12 card margin-top-m margin-left-s margin-right-s portfolio-section">
    ...
    <div class="card-content row padding-top-xl padding-bottom-xl">
        <div class="col-xs-12 col-sm-4 dashboard-chart">
            <portfolio-overview :data="{{json_encode($chart)}}"></portfolio-overview>
        </div>
        <div class="col-xs-12 col-sm-8 margin-dv-m margin-top-m">
            <div class="row">
            ...
            <div class="col-sm-10 col-xs-12">
                ...
                <div class="row col-xs-12">
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Target Investor IRR:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->investor_irr }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Target Equity Multiple:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->equity_multiple }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Target Hold Period:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->investment_period }}</h3>
                    </div>
                </div>
                <div class="row col-xs-12">
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Investment Profile:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->investment_profile }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Minimum Investment:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->investment_minimum }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Date Offers Due:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->investment_offer }}</h3>
                    </div>
                </div>
                <div class="row col-xs-12">
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Distribution Period:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->distribution_period }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Property Type:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->property_type }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Distribution Start:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $process_offering->distribution_start }}</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="margin-bottom-s margin-top-s margin-left-s margin-right-s row property-content-container" style="width: 100%;">
            ...
            <div class="col-sm-10 col-xs-12">
                ...
                <div class="row col-xs-12">
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Target Investor IRR:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->investor_irr }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Target Equity Multiple:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->equity_multiple }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Target Hold Period:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->investment_period }}</h3>
                    </div>
                </div>
                <div class="row col-xs-12">
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Investment Profile:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->investment_profile }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Minimum Investment:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->investment_minimum }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Date Offers Due:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->investment_offer }}</h3>
                    </div>
                </div>
                <div class="row col-xs-12">
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Distribution Period:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->distribution_period }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Property Type:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->property_type }}</h3>
                    </div>
                    <div class="col-sm-4 row col-xs-12">
                        <h3 class="col-sm-7 light-color col-xs-7">Distribution Start:</h3>
                        <h3 class="col-sm-5 col-xs-5">{{ $current_offering->distribution_start }}</h3>
                    </div>
                </div>
            </div>
        </div>
...
<a>
    <h3 class="margin-top-l margin-bottom-l text-center pointer-cursor">Browse More Offerings</h3>
</a>
</div>
        </div>
    </div>
